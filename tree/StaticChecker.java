...
public class StaticChecker implements DeclVisitor, StatementVisitor,
    ...
    public void visitActualParamNode(StatementNode.ActualParamNode node) {
        beginCheck("ActualParameter");
        node.getParameter().setDefaultParam(checkCondition
                (node.getParameter().getDefaultExp()));
    ...
    public ExpNode visitFormalParamNode(ExpNode.FormalParamNode node) {
        beginCheck("FormalParameter");

        endCheck("FormalParameter");
        return node;
    }
