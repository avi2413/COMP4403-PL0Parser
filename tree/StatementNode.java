...
public abstract class StatementNode {
    ...
    public static class ActualParamNode extends StatementNode {
        private final SymEntry.ParamEntry paramEntry;

        public ActualParamNode(Location loc, SymEntry.ParamEntry paramEntry) {
            super(loc);
        ...
        @Override
        public String toString(int level) {
            return paramEntry.getIdent() + "<-" + paramEntry.getDefaultExp().toString();
        }
    }
}
